...
//BL goes to 33
#define TFT_MISo 19 // THIS DOESNT MATTER AS WE NOT CONNECTED IT
#define TFT_MOSI 23 // "SDA"
#define TFT_SCLK 18 // "SCL"
#define TFT_CS 15   // Chip select control pin "CS"
#define TFT_DC 2    // Data Command control pin "DC"
#define TFT_RST 4   // Reset pin (could connect to RST pin) "RES"

#define TFT_WIDTH 128 // specify width and height
